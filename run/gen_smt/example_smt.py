...
with Solver("cvc4",
    ...
    for step in range(2):
        ...
        print(op_design_scans, og_design_scans)
    ...
    s.add_assertion(ForAll(og_design_free_vars.values(), Exists(op_design_free_vars.values(), final_constraint)))
